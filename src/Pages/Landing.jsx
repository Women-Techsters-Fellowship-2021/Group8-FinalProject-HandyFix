        ...
        <body>
            ...
            <section>
                <header className='hero-section'>
                    <div>
                        ...
                        <Link to='/landinPage' ><p className='first' id='logo'>LOGO</p></Link>
                        <Link to='#' ><p className='first' id='serv'>Services</p></Link>
                        <Link  to='#' ><p className='first' id='com'>Company</p></Link>
                    ...
                    <div>
                        <p className='hero-text'>
                            Squeaky door and need help?<br/> <b>HandyFix</b> has your back!
                        </p>
                  
                    </div>
                    <div className='hero-btn'>
                        <button type='submit'  className='bk-btn'>Book Now</button>
            ...
            <section className='sec-one'>
                ...
                <div id='sec1-text' >
                    ...
                    <p>
                        ...
                        adipisicing elit. Repudiandae sequi 
                        impedit, vero unde nulla velit aspernatur 
                        eveniet veritatis minima
                        , amet eum numquam ipsum facere 
                        necessitatibus reprehenderit nam quis
                        architecto. Voluptas.
                    </p>
                    <p className='pa-mar'>
                        Lorem, ipsum dolor sit amet consectetur
            ...
            <section className='sec-three'>
                <div className='first-cat-div'>
                    ...
                    <p>
                        We provide varying levels of service with 
                        technically skilled personnel who are
                        trained to achieve the highest level 
                ...
                <div className='img-section'>
                    <div >
                        <img src={nail} width= {210} height={120} 
                        alt=""/>
                        <figcaption>MANICURIST</figcaption>
                    </div>
                    <div>
                        <img src={tool} width= {210} height={120} 
                        alt=""/>
                        <figcaption>ELECTRICALS</figcaption>
                    </div>
                    <div>
                        <img src={carpentary} width= {210} height={120} 
                        alt=""/>
                        <figcaption>PLUMBING</figcaption>
                    </div>
                    <div>
                        <img src={firework} width= {210} height={120} 
                        alt=""/>
                        <figcaption>GENERATOR REPAIRS</figcaption>
                    </div>
                    <div>
                        <img src={drawing} width= {210} height={120} 
                        alt=""/>
                        <figcaption>AIR CONDITIONER REPAIRS</figcaption>
                    </div>
                    <div>
                        <img src={food} width= {210} height={120} 
                        alt=""/>
                        <figcaption>ELECTRICALS</figcaption>
                    </div>
            ...
            <section className='sec-four'>
                ...
                <div className='sec-four-img'>
                    <img src={firework} width= {250} height={350} 
                    alt=""/>
                    ...
                    <div className='why-us'>
                        ...
                        <div>
                            ...
                            <p> Our artisans registered with 
                                ...
                                that have been authenticated and are in 
                        ...
                        <div>
                            ...
                            times while we can also work with your 
                    ...
                    {/* className='sec-five-pa' */}
                        <div className='div-two'>
                            ...
                            <div className='inner-div'>
                                ...
                                <p >
                                    Relocation felt ordinary until I needed a plumber!!!
                                    Being new to the city, I didn’t know who I could trust.
                                    A colleague recommended HandyFix and that was all 
                                    I needed.
                                    Not only was the plumber very efficient, he was prompt 
            ...
            <footer>
                ...
                <div >
                    <p id='copy'> <b>Copyright &copy; 2021.HandyFix. All rights reserved</b></p>
